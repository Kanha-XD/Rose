document.addEventListener('DOMContentLoaded', () => {
    ...
    function spawnFallingPetal() {
        if (
            fallingPetalsEl.childElementCount > 10
        ) {
            return;
        }
        const petal =
    ...
    roseSong.addEventListener(
        'ended',
        () => {
            roseWrapper.classList.remove(
                'rotating'
            );
